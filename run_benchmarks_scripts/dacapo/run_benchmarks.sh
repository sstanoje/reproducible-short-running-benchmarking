...
#
# The commands below contain benchmark-specific paths that must be configured
# manually before running this script.
#
# PATH_TO_HOME
#   Replace with the home directory used when the DaCapo Native Image
#   executables were built/run. Some DaCapo benchmarks depend on files or
#   resources resolved relative to the user home directory.
#
# PATH_TO_LABS_JDK
#   Replace with the LabsJDK installation used for the experiments.
#   This is required by benchmarks such as fop that need access to the Java
#   runtime installation during execution.
#
# These values are intentionally not inferred automatically because they are
# specific to the benchmark build/runtime environment.
